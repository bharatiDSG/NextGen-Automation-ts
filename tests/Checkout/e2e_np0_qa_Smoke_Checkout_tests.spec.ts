...
test.describe('NP0 QA Smoke Checkout Tests', () => {
    ...
    test('1. Smoke_CHECKOUT_001_VISA_Guest', async ({ page }) => {
    ...
    test('2. Smoke_CHECKOUT_002_Different_CheckOut_Options', async ({ page }) => {
    ...
    test('3. Smoke_CHECKOUT_003_Mastercard_Registered', async ({ page }) => {
    ...
    test('4. Smoke_CHECKOUT_004_Mixed_Tender_Guest', async ({ page }) => {
    ...
    test('5. Smoke_CHECKOUT_005_Paypal Checkout', async ({ page }) => {
